...
class TransportationTableauSpec extends FlatSpec {
  ...
  "After the North-West corner rule, the tableau" should 
  ...
  "After the 1st adjustment, the tableau" should
  ...
  "After the 2nd adjustment, the tableau" should
  ...
  "After the 3rd adjustment, the tableau" should
      "then have the allocations ((20,0,80,0), (130,0,0,0), (0,120,0,50))" in {
  ...
  "After the 4th adjustment, the tableau" should
